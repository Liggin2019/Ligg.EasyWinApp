...
namespace Ligg.Winform.Helpers
{
    public static class ControlHelper
    {
        ...
        //#ListViewEx
        //public static void SetListViewExStyleByText(ListViewEx control, string styleText)
        //{
        //    try
        //    {
        //        if (styleText.IsNullOrEmpty()) return;
        //        var viewType = styleText.GetStyleValue("ViewType");
        //        if (!viewType.IsNullOrEmpty())
        //        {
        //            control.ViewTypeName = viewType.Trim();
        //        }
        //        else
        //        {
        //            control.ViewTypeName = "Details";
        //        }
        //        var rowHeightStr = styleText.GetStyleValue("RowHeight");
        //        if (!rowHeightStr.IsNullOrEmpty() & rowHeightStr.IsPlusInteger())
        //        {
        //            control.RowHeight = Convert.ToInt16(rowHeightStr);
        //        }
        //        var hasPager = styleText.GetStyleValue("HasPager");
        //        if (!hasPager.IsNullOrEmpty() & hasPager == "true")
        //        {
        //            control.HasPager = true;
        //        }
        //        var canOrder = styleText.GetStyleValue("CanOrder");
        //        if (!canOrder.IsNullOrEmpty() & canOrder == "true")
        //        {
        //            control.CanOrder = true;
        //        }
        //        var orderField = styleText.GetStyleValue("OrderField");
        //        if (!orderField.IsNullOrEmpty())
        //        {
        //            control.OrderFieldName = styleText.SplitByTwoDifferentStrings("OrderField:", ";", true)[0];
        //        }

        //        var isOrderDescending = styleText.GetStyleValue("IsOrderDescending");
        //        if (!isOrderDescending.IsNullOrEmpty() & isOrderDescending == "true")
        //        {
        //            control.IsOrderDescending = true;
        //        }
        //        else control.IsOrderDescending = false;
        //    }
        //    catch (Exception ex)
        //    {
        //        throw new ArgumentException("\n >> " + TypeName + ".SetListViewExStyleByText Error: " + ex.Message);
        //    }
        //}

        //#PagerStyle
        //public static void SetPagerStyleByText(Pager control, string styleText)
        //{
        //    try
        //    {
        //        if (styleText.IsNullOrEmpty()) return;
        //        var pageSizeStr = styleText.GetStyleValue("PageSize");
        //        if (!pageSizeStr.IsNullOrEmpty() & pageSizeStr.IsPlusInteger())
        //        {
        //            control.PageSize = Convert.ToInt16(pageSizeStr);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        throw new ArgumentException("\n >> " + TypeName + ".SetPagerStyleByText Error: " + ex.Message);
        //    }
        //}
