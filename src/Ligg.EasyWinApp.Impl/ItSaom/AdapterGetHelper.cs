        ...
        internal static string GetText(string funcName, string[] funcParamArray)
        {
            try
            {
                ...
                else if (funcName.ToLower() == ("JobService".ToLower()))
                {
                    ...
                    {
                        return new JobService().GetJobExecType();
                    }
                    else if (funcParamArray[0].ToLower() == "GetJobExecParams".ToLower())
                    {
                        return new JobService().GetJobExecParams();
                    }
                    else if (funcParamArray[0].ToLower() == "GetJobDisplayName".ToLower())
                    {
                        return new JobService().GetJobDisplayName();
                    }
                    else if (funcParamArray[0].ToLower() == "GetTaskList".ToLower())
                    {
                        return new JobService().GetTaskList();
                    }
                    else if (funcParamArray[0].ToLower() == "GetTaskCount".ToLower())
                    {
                        return (new JobService().GetTaskCount()).ToString();
                    }
                    else if (funcParamArray[0].ToLower() == "GetTaskAction".ToLower())
                    {
                        return new JobService().GetTaskAction(Convert.ToInt32(funcParamArray[1]));
                    }
                ...
                else if (funcName.ToLower() == ("WinConfigService".ToLower()))
                {
                    ...
                    else if (funcParamArray[0].ToLower() == "GetSelectedWinConfigGroupIds".ToLower())
                    {
                        return new WinConfigService().GetSelectedWinConfigGroupIds();
                    }
                    else throw new ArgumentException("funcName: " + funcName + " has no param '" + funcParamArray[0] + "'! ");
                }
                ...
                else if (funcName.ToLower() == ("UserService".ToLower()))
                {
                    ...
                    {
                        var tmpArray = funcParamArray[1].Split(GlobalConfiguration.GetSubParamSeparator(funcParamArray[1]));
